# Picovoice SDK for Arduino boards - Swedish language
...
1. Compile and upload the `Picovoice_SV/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
